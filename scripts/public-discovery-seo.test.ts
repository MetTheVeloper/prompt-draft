...
test('Discovery consumers reuse the shared catalog and native SSR owns SEO projection', async () => {
  ...
  assert.doesNotMatch(generator, /cleanupLegacyDiscoveryArtifacts/)
  assert.doesNotMatch(generator, /data-public-seo-snapshot/)
  assert.doesNotMatch(generator, /data-public-seo-structured/)
})
