export default {
  ...
  pwa: {
    offline: {
      prompt: {
        title: "استفاده آفلاین از Prompt Draft",
        updateTitle: "به‌روزرسانی نسخه آفلاین",
        subtitle: "بسته آفلاین",
        description:
          "همه فایل‌های موردنیاز برنامه ({size}) دانلود شوند تا Prompt Draft بدون اینترنت هم کار کند.",
        updateDescription:
          "نسخه جدید بسته آفلاین آماده است ({size}). برای به‌روز ماندن حالت آفلاین آن را دانلود کن.",
        backgroundHint:
          "دانلود در پس‌زمینه انجام می‌شود و هنگام دانلود می‌توانی به استفاده از برنامه ادامه بدهی.",
        action: "دانلود برای استفاده آفلاین",
        updateAction: "به‌روزرسانی نسخه آفلاین",
        later: "فعلاً نه",
      },
      status: {
        downloading: "دانلود آفلاین · {progress}٪",
  ...
  pages: {
    collage: {
      ...
      preview: {
        ...
        loopSuffix: " · لوپ",
        recordingVideo: "در حال ضبط ویدئو...",
      ...
      textOverlay: {
        enabled: "متن روی تصویر",
        font: "فونت متن",
        text: "متن روی تصویر",
        placeholder: "مثلا: پرامپت تبدیل به سبک نقاشی آبرنگ",
        size: "اندازه متن",
        color: "رنگ متن",
        gap: "فاصله متن و برند",
      },
      safeArea: {
        title: "محدوده امن",
      },
      video: {
        ...
        quality: "کیفیت MP4",
        qualityPresets: {
          compact: "کم‌حجم — فایل کوچک‌تر",
          balanced: "متعادل — پیشنهادی",
          high: "بالا — فایل بزرگ‌تر",
        },
        backgroundMusic: "موسیقی پس‌زمینه",
        removeAudio: "حذف صدا",
        preset: "پیش‌تنظیم",
        presets: {
          storyReel: "استوری / ریلز — 1080×1920",
          portraitPost: "پست پرتره — 1080×1350",
          squarePost: "پست مربعی — 1080×1080",
          landscape: "افقی — 1920×1080",
        },
        width: "عرض",
        height: "ارتفاع",
        calculatedDuration: "مدت زمان محاسبه‌شده",
        durationMeta: "{slides} نمایش اسلاید · {transitions} ترنزیشن",
        loop: "لوپ یکپارچه به تصویر اول",
        repeat: "تکرار: {value}×",
        fps: "نرخ فریم: {value}",
        imageInterval: "فاصله تصاویر: {value}ms",
  ...
  modules: {
      ...
      fields: {
        ...
        medium: {
          ...
          options: {
            ...
            painterly: "نقاشانه",
            cgi: "CGI",
            digital_painting: "نقاشی دیجیتال",
            game_asset_render: "رندر گیم‌اَست",
            low_poly_render: "رندر Low Poly",
            pixel_art_digital: "پیکسل‌آرت دیجیتال",
            vector_illustration: "تصویرسازی وکتور",
            acrylic_painting: "نقاشی اکریلیک",
            ceramic_sculpture: "مجسمه سرامیکی",
            charcoal_drawing: "طراحی با زغال",
            cinematic_photo: "عکس سینمایی",
            clay_sculpture: "مجسمه گِلی",
            collectible_figure: "فیگور کلکسیونی",
            colored_pencil_drawing: "طراحی با مداد رنگی",
            etching_print: "چاپ اِچینگ",
            fabric_doll: "عروسک پارچه‌ای",
            felt_craft: "کاردستی نمدی",
            gouache_painting: "نقاشی گواش",
            handmade_model: "مدل دست‌ساز",
            ink_and_wash: "مرکب و واش",
            ink_drawing: "طراحی با مرکب",
            linocut_print: "چاپ لینوکات",
            macro_photography: "عکاسی ماکرو",
            marker_render: "رندر با ماژیک",
            mixed_media_collage: "کلاژ میکس‌مدیا",
            oil_painting: "نقاشی رنگ روغن",
            origami_art: "هنر اوریگامی",
            outdoor_photography: "عکاسی فضای باز",
            paper_collage: "کلاژ کاغذی",
            paper_craft: "کاردستی کاغذی",
            paper_cutout: "برش کاغذی",
            paper_mache_sculpture: "مجسمه پاپیه ماشه",
            pastel_drawing: "طراحی پاستل",
            pen_and_ink: "قلم و مرکب",
            pencil_drawing: "طراحی با مداد",
            photography: "عکاسی",
            photomontage: "فتومونتاژ",
            plasticine_sculpture: "مجسمه پلاستیسین",
            plush_toy: "عروسک پولیشی",
            risograph_print: "چاپ ریزوگراف",
            screen_print: "چاپ سیلک",
            stitched_textile_art: "هنر پارچه‌ای دوخته‌شده",
            studio_photography: "عکاسی استودیویی",
            vinyl_toy_model: "مدل وینیل توی",
            watercolor_painting: "نقاشی آبرنگ",
            woodcut_print: "چاپ چوبی",
          },
        },
        stylizationLevel: {
    ...
    colorPalette: {
      ...
      fields: {
        paletteAssignments: {
          ...
          controls: {
            color: {
              placeholder: "یک رنگ انتخاب کن یا بنویس...",
            },
          },
        },
        extraDetails: {
    ...
    typography: {
      description:
        "دستورهای تایپوگرافی را با گروه‌های متنی قابل استفاده، چیدمان، سلسله‌مراتب و جزئیات استایل تعریف کن.",
      fields: {
        textGroups: {
          description:
          ...
          block: {
            ...
            controls: {
              ...
              customFontSize: {
                label: "اندازه فونت سفارشی",
                placeholder:
                  "اندازه دلخواه را توضیح بده؛ مثل تیتر خیلی بزرگ، کپشن کوچک، حروف سه‌بعدی عظیم یا متن متعادل...",
              },
              customFontWeight: {
                label: "وزن فونت سفارشی",
                placeholder:
                  "وزن دلخواه را توضیح بده؛ مثل خیلی ضخیم، نازک، سنگین، سبک، حجیم یا ظریف...",
              },
              customPurpose: {
                label: "هدف سفارشی",
                placeholder:
                  "نقش سفارشی این متن را توضیح بده؛ مثل نام برند، لیبل مداری، کال‌اوت، عنوان، زیرعنوان یا تایپ تزئینی...",
              },
            },
            validation: {
        ...
        extraDetails: {
          description:
            "نکته‌های کلی تایپوگرافی را اضافه کن؛ مثل خوانایی، رفتار چیدمان، متریال یا حال‌وهوای بصری متن‌ها.",
          label: "جزئیات تکمیلی",
          placeholder:
            "هر قانون کلی برای تایپوگرافی، خوانایی، متریال یا رفتار چیدمان سفارشی را توضیح بده...",
        },
        textAccuracy: {
          description: "مشخص کن خروجی تا چه حد باید متن نوشته‌شده را دقیق حفظ کند.",
          label: "دقت متن",
          options: {
            exact: "دقیق",
      ...
      groups: {
        advanced: {
          description:
            "جزئیات تایپوگرافی مثل فاصله‌گذاری، متریال، خوانایی، عمق و رفتار چیدمان را دقیق‌تر تنظیم کن.",
          title: "تایپوگرافی پیشرفته",
        },
        core: {
          description:
            "ساختار اصلی تایپوگرافی، گروه‌های متنی، محتوا، سلسله‌مراتب و جای‌گذاری را تعریف کن.",
          title: "تایپوگرافی اصلی",
        },
      },
      title: "تایپوگرافی",
    },
    variables: {
      description:
        "متغیرهای قابل استفاده در پرامپت بساز تا بتوانی آن‌ها را داخل فیلدهای مختلف وارد و دوباره استفاده کنی.",
      fields: {
        variables: {
          description:
            "متغیرهای نام‌گذاری‌شده برای متن، سوژه، رنگ، رفرنس، آبجکت یا مقدارهای سفارشی پرامپت تعریف کن.",
          label: "متغیرها",
          types: {
            color: "رنگ",
            custom: "سفارشی",
          ...
          empty: {
            ...
            description:
              "اولین متغیر را اضافه کن، بعد می‌توانی آن را داخل فیلدهای پرامپت استفاده کنی.",
          },
          list: {
            count: "{count} متغیر",
            hint: "برای ویرایش، روی متغیر کلیک کن.",
            emptyValue: "بدون مقدار",
            disabled: "غیرفعال",
          },
          modal: {
            createTitle: "افزودن متغیر",
            editTitle: "ویرایش {token}",
            editorSubtitle: "متغیر را یک‌بار تعریف کن و در فیلدهای مختلف پرامپت دوباره استفاده کن.",
            deleteTitle: "حذف متغیر",
            deleteDescription: "آیا از حذف {token} مطمئن هستید؟",
            deleteWarning:
              "اگر این توکن در فیلدهای دیگر پرامپت استفاده شده باشد، بعد از حذف دیگر با مقدار جایگزین نمی‌شود.",
          },
          validation: {
      ...
      groups: {
        core: {
          description: "لیست اصلی متغیرهای قابل استفاده داخل ادیتور پرامپت را مدیریت کن.",
          title: "متغیرهای اصلی",
        },
      },
      title: "متغیرها",
  ...
  promptSetup: {
    ...
    aspectRatio: {
      ...
      groups: {
        ...
        socialBanners: {
          label: "بنرهای شبکه اجتماعی",
        },
        webUiAds: {
          label: "وب، رابط کاربری و تبلیغات",
        },
      },
      options: {
        a0Landscape: {
          label: "A0 افقی",
          description:
            "فرمت چاپی بزرگ و افقی ISO، مناسب پوسترهای خیلی بزرگ، بنرها، گرافیک نمایشگاهی و چیدمان‌های عریض.",
        },
        a0Portrait: {
          label: "A0 عمودی",
          description:
            "فرمت چاپی بزرگ و عمودی ISO، مناسب پوسترهای خیلی بزرگ، تابلوها، گرافیک نمایشگاهی و طراحی‌های چاپی ویژه.",
        },
        a1Landscape: {
          label: "A1 افقی",
          description:
            "فرمت چاپی A1 افقی، مناسب پوسترها، بردهای ارائه، گرافیک رویداد و چیدمان‌های افقی بزرگ.",
        },
        a1Portrait: {
          label: "A1 عمودی",
          description:
            "فرمت چاپی A1 عمودی، مناسب پوسترها، بردهای اطلاع‌رسانی، طراحی رویداد و چاپ‌های تبلیغاتی بزرگ.",
        },
        a2Landscape: {
          label: "A2 افقی",
          description:
            "فرمت چاپی A2 افقی، مناسب پوسترهای متوسط تا بزرگ، بردها، منوها و چیدمان‌های تبلیغاتی.",
        },
        a2Portrait: {
          label: "A2 عمودی",
          description:
            "فرمت چاپی A2 عمودی، مناسب پوسترها، آرت‌پرینت‌ها، اعلان‌های رویداد و طراحی‌های تبلیغاتی متوسط تا بزرگ.",
        },
        a3Landscape: {
          label: "A3 افقی",
          description:
            "فرمت A3 افقی، مناسب پوسترها، شیت‌های ارائه، منوها و گرافیک‌های نمایشی جمع‌وجور.",
        },
        a3Portrait: {
          label: "A3 عمودی",
          description:
            "فرمت A3 عمودی، مناسب پوسترها، فلایرها، شیت‌های ارائه و چیدمان‌های چاپی جمع‌وجور.",
        },
        a4Landscape: {
          label: "A4 افقی",
          description:
            "فرمت استاندارد سند افقی، مناسب گزارش‌ها، شیت‌ها، ارائه‌ها و چیدمان‌های آماده چاپ.",
        },
        a4Portrait: {
          label: "A4 عمودی",
          description:
            "فرمت استاندارد سند عمودی، مناسب سندها، فلایرها، ورک‌شیت‌ها و طراحی‌های چاپی روزمره.",
        },
        a5Landscape: {
          label: "A5 افقی",
          description:
            "فرمت چاپی کوچک و افقی، مناسب کارت‌های کوچک، بروشورها، دعوت‌نامه‌ها و طراحی‌های چاپی تاخورده.",
        },
        a5Portrait: {
          label: "A5 عمودی",
          description:
            "فرمت چاپی کوچک و عمودی، مناسب فلایرها، پوسترهای کوچک، جلد دفترچه و طراحی‌های دستی.",
        },
        a6Landscape: {
          label: "A6 افقی",
          description:
            "فرمت چاپی کوچک و افقی، مناسب کارت‌پستال، فلایر جمع‌وجور، کوپن و کارت‌های تبلیغاتی کوچک.",
        },
        a6Portrait: {
          description: "فرمت چاپی کوچک و عمودی، مناسب کارت‌های جمع‌وجور، فلایرها و طراحی‌های دستی.",
          label: "A6 عمودی",
        },
        albumCover: {
          label: "کاور آلبوم",
          description:
            "فرمت مربعی کاور، مناسب آلبوم موسیقی، پلی‌لیست، کاور پادکست و گرافیک هویت بصری.",
        },
        appSplashLandscape: {
          label: "اسپلش‌اسکرین اپ افقی",
          description:
            "فرمت افقی اسپلش‌اسکرین اپ، مناسب صفحه شروع اپلیکیشن در حالت افقی موبایل یا تبلت.",
        },
        appSplashPortrait: {
          label: "اسپلش‌اسکرین اپ عمودی",
          description:
            "فرمت عمودی اسپلش‌اسکرین اپ، مناسب صفحه شروع موبایل، تصویرهای onboarding و گرافیک لانچ اپ.",
        },
        bookCover: {
          label: "جلد کتاب",
          description: "فرمت عمودی جلد کتاب، مناسب رمان، راهنما، ایبوک و طراحی‌های کاور ادیتوریال.",
        },
        businessCardHorizontal: {
          description: "فرمت استاندارد کارت ویزیت افقی، مناسب طراحی‌های هویتی آماده چاپ.",
          label: "کارت ویزیت افقی",
        },
        businessCardVertical: {
          label: "کارت ویزیت عمودی",
          description:
            "فرمت کارت ویزیت عمودی، مناسب کارت‌های هویتی مدرن، برندینگ شخصی و چیدمان‌های فشرده اطلاعات تماس.",
        },
        commonCinematicWide: {
          label: "واید سینمایی",
          description:
            "نسبت خیلی عریض سینمایی، مناسب صحنه‌های دراماتیک، فریم فیلم، تریلر و ترکیب‌بندی‌های پانورامیک.",
        },
        commonLandscapeFiveFour: {
          label: "افقی ۵:۴",
          description:
            "نسبت افقی متعادل ۵:۴، مناسب چیدمان‌های ادیتوریال، چاپ‌های قاب‌شده و ترکیب‌بندی‌های افقی کنترل‌شده.",
        },
        commonLandscapeFourThree: {
          description:
            "نسبت افقی کلاسیک ۴:۳، مناسب ارائه‌ها، چیدمان‌های ادیتوریال و ترکیب‌بندی‌های عمومی تصویر.",
          label: "افقی ۴:۳",
        },
        commonPhotoLandscape: {
          label: "عکس افقی",
          description:
            "نسبت کلاسیک عکس افقی، مناسب عکاسی، تصویر محصول، صحنه‌های سفر و چیدمان‌های تصویری افقی.",
        },
        commonPhotoPortrait: {
          label: "عکس عمودی",
          description:
            "نسبت کلاسیک عکس عمودی، مناسب پرتره، فشن‌شات، تصویر محصول و ترکیب‌بندی‌های عمودی.",
        },
        commonPortraitFourFive: {
          label: "عمودی ۴:۵",
          description:
            "نسبت عمودی محبوب ۴:۵، مناسب پست‌های شبکه اجتماعی، پرتره، نمایش محصول و چیدمان‌های مناسب فید.",
        },
        commonPortraitThreeFour: {
          label: "عمودی ۳:۴",
          description: "نسبت عمودی کلاسیک ۳:۴، مناسب پرتره، پوستر، کارت و طراحی‌های عمودی متعادل.",
        },
        commonSquare: {
          label: "مربع ۱:۱",
          description:
            "نسبت مربعی ساده، مناسب آیکون، کاور، تصویر محصول، پست شبکه اجتماعی و ترکیب‌بندی‌های مرکزی.",
        },
        commonVertical: {
          label: "عمودی ۹:۱۶",
          description:
            "نسبت عمودی بلند، مناسب استوری، ریلز، پوسترهای موبایل‌محور و چیدمان‌های تمام‌صفحه شبکه اجتماعی.",
        },
        commonWidescreen: {
          label: "وایداسکرین ۱۶:۹",
          description:
            "نسبت استاندارد وایداسکرین، مناسب ویدئو، تامبنیل، ارائه، بنر و ترکیب‌بندی‌های افقی.",
        },
        facebookPageCover: {
          label: "کاور صفحه فیسبوک",
          description:
            "فرمت واید کاور صفحه فیسبوک، مناسب هدر برند، تصویر کمپین و بنر پروفایل شبکه اجتماعی.",
        },
        greetingCardSquare: {
          label: "کارت تبریک مربعی",
          description:
            "فرمت مربعی کارت تبریک، مناسب کارت‌های مناسبتی، دعوت‌نامه، یادداشت هدیه و تبریک‌های شبکه اجتماعی.",
        },
        instagramLandscapePost: {
          label: "پست افقی اینستاگرام",
          description:
            "فرمت پست افقی اینستاگرام، مناسب تصاویر عریض محصول، عکاسی، اطلاع‌رسانی و محتوای فید.",
        },
        instagramPhotoPost: {
          label: "پست عکس اینستاگرام",
          description:
            "فرمت استاندارد پست عکس اینستاگرام، مناسب پست‌های تصویری تمیز، تصاویر لایف‌استایل و محتوای بصری فید.",
        },
        instagramPortraitPost: {
          label: "پست عمودی اینستاگرام",
          description:
            "فرمت عمودی فید اینستاگرام، مناسب نمایش محصول، پرتره، پوستر و پست‌های تاثیرگذار.",
        },
        instagramSquarePost: {
          description:
            "فرمت کلاسیک پست مربعی اینستاگرام، مناسب پست‌های فید، عکس محصول و چیدمان‌های تمیز شبکه اجتماعی.",
          label: "پست مربعی اینستاگرام",
        },
        instagramStoryReel: {
          label: "استوری / ریل اینستاگرام",
          description:
            "فرمت عمودی تمام‌صفحه اینستاگرام، مناسب استوری، ریلز، ویدئوهای کوتاه و پوسترهای موبایل‌محور.",
        },
        invitationLandscape: {
          label: "دعوت‌نامه افقی",
          description:
            "فرمت دعوت‌نامه افقی، مناسب کارت رویداد، دعوت‌نامه عروسی، اطلاع‌رسانی و چیدمان‌های چاپی ظریف.",
        },
        invitationPortrait: {
          label: "دعوت‌نامه عمودی",
          description:
            "فرمت دعوت‌نامه عمودی، مناسب کارت رویداد، دعوت‌نامه عروسی، اطلاع‌رسانی و چیدمان‌های رسمی.",
        },
        leaderboardAd: {
          label: "تبلیغ لیدربورد",
          description:
            "فرمت تبلیغ افقی و عریض، مناسب هدر سایت، تبلیغات نمایشی، بنر کمپین و جایگاه‌های تبلیغاتی.",
        },
        linkedinCover: {
          label: "کاور لینکدین",
          description:
            "فرمت واید کاور لینکدین، مناسب پروفایل حرفه‌ای، صفحه شرکت، برندینگ شخصی و تصویرهای کاری.",
        },
        magazineCover: {
          label: "جلد مجله",
          description:
            "فرمت عمودی جلد مجله، مناسب طراحی ادیتوریال، کاور فشن، داستان ویژه و چیدمان‌های نشریه.",
        },
        mediumRectangleAd: {
          label: "تبلیغ مستطیل متوسط",
          description:
            "فرمت استاندارد تبلیغ مستطیل متوسط، مناسب تبلیغات وب، جایگاه‌های سایدبار و گرافیک کمپین.",
        },
        moviePoster: {
          label: "پوستر فیلم",
          description:
            "فرمت عمودی پوستر فیلم، مناسب پوسترهای سینمایی، کی‌آرت، پروموی رویداد و ترکیب‌بندی‌های دراماتیک.",
        },
        postcardHorizontal: {
          label: "کارت‌پستال افقی",
          description:
            "فرمت کارت‌پستال افقی، مناسب کارت سفر، ارسال تبلیغاتی، تبریک و طراحی‌های چاپی جمع‌وجور.",
        },
        postcardVertical: {
          label: "کارت‌پستال عمودی",
          description:
            "فرمت کارت‌پستال عمودی، مناسب کارت تبلیغاتی، تبریک، تصویر سفر و چیدمان چاپی جمع‌وجور.",
        },
        posterLandscapeFiveFour: {
          label: "پوستر افقی ۵:۴",
          description:
            "نسبت پوستر افقی با قاب متعادل، مناسب آرت‌پرینت، اطلاع‌رسانی و طراحی پوستر افقی.",
        },
        posterLandscapeFourThree: {
          label: "پوستر افقی ۴:۳",
          description:
            "نسبت کلاسیک پوستر افقی، مناسب پوستر رویداد، تصویر ارائه و چیدمان تبلیغاتی عریض.",
        },
        posterLandscapeThreeTwo: {
          label: "پوستر افقی ۳:۲",
          description: "نسبت عریض پوستر افقی، مناسب پوسترهای سینمایی، چاپ عکس و گرافیک کمپین افقی.",
        },
        posterPortraitFourFive: {
          label: "پوستر عمودی ۴:۵",
          description:
            "نسبت پوستر عمودی، مناسب پوستر شبکه اجتماعی، نمایش محصول، پرتره و چیدمان تبلیغاتی تمیز.",
        },
        posterPortraitThreeFour: {
          label: "پوستر عمودی ۳:۴",
          description:
            "نسبت متعادل پوستر عمودی، مناسب پوستر رویداد، گرافیک ادیتوریال و ترکیب‌بندی آماده چاپ.",
        },
        posterPortraitTwoThree: {
          description:
            "نسبت کلاسیک پوستر عمودی، مناسب پوستر فیلم، پوستر رویداد و طراحی‌های تبلیغاتی چاپی.",
          label: "پوستر عمودی ۲:۳",
        },
        squareAd: {
          label: "تبلیغ مربعی",
          description:
            "فرمت تبلیغ مربعی، مناسب تبلیغات شبکه اجتماعی، پروموی محصول، تصویر کمپین و جایگاه‌های تبلیغاتی فشرده.",
        },
        squareBusinessCard: {
          label: "کارت ویزیت مربعی",
          description:
            "فرمت کارت ویزیت مربعی، مناسب کارت‌های هویتی خلاقانه، برندینگ مدرن و طراحی فشرده اطلاعات تماس.",
        },
        tiktokShortsReels: {
          label: "تیک‌تاک / شورتس / ریلز",
          description:
            "فرمت عمودی تمام‌صفحه برای ویدئو کوتاه، مناسب تیک‌تاک، یوتیوب شورتس، ریلز و محتوای موبایل‌محور.",
        },
        webBannerWide: {
          label: "بنر واید وب",
          description:
            "فرمت بنر واید وب، مناسب هدر سایت، بخش‌های لندینگ، بنر کمپین و تبلیغات دیجیتال.",
        },
        websiteHeroUltraWide: {
          label: "هیروی خیلی واید سایت",
          description:
            "فرمت خیلی عریض هیروی سایت، مناسب لندینگ‌پیج‌های immersive، هدرهای بزرگ و تصویرهای سینمایی وب.",
        },
        websiteHeroWide: {
          description: "فرمت واید برای هیروی سایت، مناسب لندینگ‌پیج‌ها، هدرها و بنرهای بزرگ وب.",
          label: "هیروی واید سایت",
        },
        xTwitterHeader: {
          label: "هدر X / توییتر",
          description:
            "فرمت واید هدر X / توییتر، مناسب برندینگ پروفایل، هدر کمپین و طراحی بنر شبکه اجتماعی.",
        },
        youtubeChannelBanner: {
          label: "بنر کانال یوتیوب",
          description:
            "فرمت واید بنر کانال یوتیوب، مناسب برندینگ کانال، هویت بصری کریتور و آرت‌ورک هدر.",
        },
        youtubeThumbnail: {
          description:
            "فرمت استاندارد تامبنیل یوتیوب، مناسب پیش‌نمایش ویدئو و تصویر کاور قابل کلیک.",
          label: "تامبنیل یوتیوب",
        },
      },
    },
    core: {
  ...
  tools: {
    imageVectorizer: {
      title: "تبدیل تصویر به وکتور",
      subtitle:
        "لوگوها و تصاویر فلت کم‌رنگ را مستقیماً در مرورگر به مسیرهای SVG قابل ویرایش تبدیل کنید.",
      empty: {
        title: "تصویر ساده را اینجا رها کنید",
        description:
          "یک لوگوی فلت PNG، JPG یا WebP با پس‌زمینه ساده و تعداد رنگ محدود انتخاب کنید.",
        action: "انتخاب تصویر",
      },
      selected: {
        details: "{width} × {height} پیکسل · {size}",
      },
      palettePicker: {
        presets: "پالت فعلی",
        confirm: "اعمال رنگ",
      ...
      actions: {
        ...
        clear: "حذف تصویر",
        pickBackground: "انتخاب پس‌زمینه",
        cancelPicker: "لغو انتخابگر",
        autoBackground: "تشخیص خودکار رنگ",
        download: "دانلود SVG",
        processing: "در حال ساخت SVG...",
        editPaletteColor: "تغییر رنگ {color}",
        keepCurrentImage: "نگه داشتن تصویر فعلی",
        replaceWithClipboard: "جایگزینی با کلیپ‌بورد",
        processingImage: "در حال ساخت PNG...",
        downloadPng: "دانلود PNG",
      },
      contextMenu: {
        downloadSvg: "دانلود SVG",
        copySvg: "کپی کد SVG",
        downloadPng: "دانلود PNG کاهش‌رنگ‌یافته",
        copyPng: "کپی PNG کاهش‌رنگ‌یافته",
        pasteImage: "جایگذاری تصویر",
        removeImage: "پاک کردن تصویر",
        copyConfig: "کپی کانفیگ",
        pasteConfig: "پیست کانفیگ",
      },
      controls: {
        maxColors: "حداکثر تعداد رنگ",
        maxColorsHint: "در حالت عادی پالت خروجی به این تعداد رنگ کاهش پیدا می‌کند.",
        colorTolerance: "تلورانس رنگ",
        colorToleranceHint:
          "مقادیر بیشتر، رنگ‌های نزدیک حاصل از فشرده‌سازی JPG و لبه‌های Anti-alias را بیشتر با هم ادغام می‌کنند.",
        strictColorLimit: "رد کردن تصاویر بیشتر از محدودیت رنگ",
        strictColorLimitHint:
          "با فعال بودن این گزینه، تصویر پررنگ به‌جای کاهش پالت پردازش نمی‌شود.",
        removeBackground: "حذف پس‌زمینه",
        trimCanvas: "برش بوم تا محدوده محتوا",
        trimCanvasHint: "برای حفظ ابعاد اصلی بوم، این گزینه را غیرفعال کنید.",
        padding: "فاصله امن خروجی",
        minRegionSize: "حداقل اندازه ناحیه",
        minRegionSizeHint:
          "ناحیه‌های جداافتاده کوچک‌تر از این مقیاس به‌عنوان نویز فشرده‌سازی حذف می‌شوند.",
        smooth: "نرمی مسیر",
        smoothHint:
          "خطوط مستقیم، منحنی‌ها و شکست‌های محافظت‌شده جداگانه تحلیل می‌شوند؛ مقدار بیشتر منحنی‌ها و لبه‌های پله‌ای را تمیز می‌کند، بدون اینکه گوشه‌های عمدی گرد شوند.",
        edgeCleanup: "پاک‌سازی لبه‌ها",
        edgeCleanupHint:
          "پیکسل‌های نازک باقی‌مانده و هاله‌های روشن اطراف لبه‌های تبدیل‌شده را پاک می‌کند.",
        removeEnclosedBackground: "حذف پس‌زمینه محصور",
        removeEnclosedBackgroundHint:
          "بخش‌های هم‌رنگ پس‌زمینه را که داخل شکل‌ها گیر افتاده‌اند حذف می‌کند؛ مثل حفره‌ها، شکاف‌ها و ناحیه‌های بسته.",
        refineSvg: "اصلاح SVG",
        refineSvgHint:
          "یک مرحله اصلاح اضافه روی سطح SVG اعمال می‌کند تا فاصله‌های ریز بین ناحیه‌های تبدیل‌شده کمتر شود. روی تصویرهای پیچیده ممکن است کندتر باشد.",
        enhanceLowRes: "بهبود تصویر کم‌رزولوشن",
        enhanceLowResHint:
          "تصویرهای کوچک یا کم‌رزولوشن را قبل از وکتورسازی بهبود می‌دهد تا شکل‌ها و لبه‌ها تمیزتر بازیابی شوند.",
        lowResRecovery: "بازیابی کم‌رزولوشن",
        lowResRecoveryHint:
          "مشخص می‌کند ابزار با چه شدتی جزئیات ازدست‌رفته را قبل از trace کردن تصویر بازسازی کند.",
        lowResScale: "اسکیل کم‌رزولوشن",
        lowResScaleHint:
          "ورودی کم‌رزولوشن را قبل از trace کردن بزرگ‌تر می‌کند. مقدارهای بالاتر ممکن است بازیابی شکل‌ها را بهتر کنند اما کندتر هستند.",
        smoothMode: "مرحله نرم‌سازی",
        smoothModeHint:
          "مشخص کن وقتی بهبود تصویر کم‌رزولوشن فعال است، نرم‌سازی قبل از کاهش اندازه، بعد از کاهش اندازه یا در هر دو مرحله انجام شود.",
        mode: "حالت ابزار",
        refineImage: "اصلاح تصویر",
        refineImageHint:
          "شکاف‌های باریک پیکسلی را پر می‌کند و پیکسل‌های درز را به ناحیه‌ی مجاور غالب می‌چسباند.",
        edgeSmooth: "نرمی لبه‌ها",
        edgeSmoothHint: "لبه‌های پله‌ای تصویر را بدون ترکیب‌کردن رنگ‌های ایندکس‌شده نرم می‌کند.",
      },
      values: {
        colors: "{count} رنگ",
        auto: "خودکار",
        ...
        mode: {
          vectorize: "تبدیل به وکتور",
          upscale: "بزرگ‌نمایی هوشمند",
        },
      },
      preview: {
        original: "تصویر اصلی",
        quantized: "پیش‌نمایش کاهش رنگ",
        vector: "پیش‌نمایش SVG",
        empty: "تصویری انتخاب نشده است",
        pending: "پیش‌نمایش بعد از پردازش نمایش داده می‌شود.",
        pickHint: "روی رنگ پس‌زمینه در تصویر اصلی کلیک کنید.",
        upscaled: "پیش‌نمایش بزرگ‌شده",
      },
      result: {
        palette: "پالت تشخیص‌داده‌شده",
        details: "SVG: {width} × {height} پیکسل · {colors} رنگ · {regions} ناحیه",
        optimization: "تعداد نقاط مسیر از {before} به {after} کاهش یافت ({percent}٪).",
        upscaleDetails: "PNG: {width} × {height}px · {colors} رنگ · {regions} ناحیه",
        outputColors: "{count} رنگ خروجی",
      },
      status: {
        loading: "در حال بارگذاری تصویر...",
        processing: "در حال تحلیل رنگ‌ها و ترسیم مسیرها...",
        ready: "پیش‌نمایش SVG آماده است.",
        svgCopied: "کد SVG در کلیپ‌بورد کپی شد.",
        pngCopied: "تصویر PNG کاهش‌رنگ‌یافته در کلیپ‌بورد کپی شد.",
        configCopied: "کانفیگ ابزار در کلیپ‌بورد کپی شد.",
        configPasted: "کانفیگ ابزار اعمال شد.",
        upscaleReady: "فایل PNG بزرگ‌شده آماده است.",
      },
      messages: {
        unsupportedFile: "یک تصویر PNG، JPG، WebP، GIF، BMP یا AVIF معتبر انتخاب کنید.",
        colorLimitTitle: "تعداد رنگ‌های تصویر زیاد است",
        colorLimitExceeded:
          "در این تصویر حدود {detected} گروه رنگ تشخیص داده شد که از محدودیت {max} بیشتر است. تلورانس یا حداکثر تعداد رنگ را افزایش دهید، حالت سخت‌گیرانه را خاموش کنید یا تصویر ساده‌تری انتخاب کنید.",
        processingFailed:
          "تبدیل تصویر به وکتور انجام نشد. یک تصویر ساده‌تر امتحان کنید، تلورانس رنگ را افزایش دهید یا ابعاد تصویر ورودی را کاهش دهید.",
        clipboardUnavailable:
          "دسترسی لازم به کلیپ‌بورد برای این عملیات در مرورگر پشتیبانی نمی‌شود.",
        clipboardPermissionDenied:
          "مجوز دسترسی به کلیپ‌بورد رد شد. دسترسی را فعال و دوباره تلاش کنید.",
        clipboardWriteFailed: "کپی خروجی در کلیپ‌بورد انجام نشد.",
        clipboardReadFailed: "خواندن اطلاعات از کلیپ‌بورد انجام نشد.",
        noClipboardImage: "تصویری داخل کلیپ‌بورد پیدا نشد.",
        invalidConfig: "محتوای کلیپ‌بورد یک کانفیگ معتبر برای ابزار تبدیل وکتور نیست.",
        replaceClipboardImageTitle: "تصویر فعلی جایگزین شود؟",
        replaceClipboardImageConfirm:
          "پیست کردن تصویر جدید از کلیپ‌بورد، تصویر منبع فعلی و نتیجه‌ی فعلی آن را جایگزین می‌کند.",
      },
      progress: {
        preparing: "در حال آماده‌سازی...",
        enhancing: "در حال بهبود تصویر...",
        quantizing: "در حال کوانتایز رنگ‌ها...",
        background: "در حال تشخیص پس‌زمینه...",
        regions: "در حال ساخت ناحیه‌ها...",
        tracing: "در حال trace کردن شکل‌ها...",
        svg: "در حال ساخت SVG...",
        preview: "در حال رندر پیش‌نمایش...",
        finalizing: "در حال نهایی‌سازی...",
        refiningImage: "در حال اصلاح ناحیه‌های تصویر...",
        smoothingEdges: "در حال نرم‌کردن لبه‌های تصویر...",
      },
    },
    imageConverter: {
      title: "تبدیل تصاویر",
      subtitle:
        "تصاویر را آپلود کن، تنظیمات خروجی را انتخاب کن و همه فایل‌های تبدیل‌شده را به صورت ZIP دانلود کن.",
      empty: {
      ...
      messages: {
        ...
        exportFailed:
          "تبدیل تصاویر انتخاب‌شده انجام نشد. فایل‌های دیگری را امتحان کن یا تعداد فایل‌ها را کمتر کن.",
      },
      preview: {
    ...
    about: {
      ...
      description:
        "Prompt Draft یک محیط ماژولار برای ساخت پرامپت‌های ساختاریافته‌ی تولید تصویر است که با ماژول‌های قابل استفاده مجدد، متغیرها، مدیریت درفت‌ها و ابزارهای کمکی کوچک، روند ایده‌پردازی و تولید پرامپت را سریع‌تر و منظم‌تر می‌کند.",
    },
  },
  components: {
    contextMenu: {
  ...
  prompts: {
    ...
    description: "پرامپت‌های منتشرشده در کانال تلگرام Prompt Draft را مرور کنید.",
    total: "{count} پرامپت",
    results: "{count} نتیجه",
    loading: "در حال بارگذاری آرشیو پرامپت‌ها...",
    search: {
      placeholder: "جستجو در عنوان، متن پرامپت، تگ یا شناسه...",
    },
    filters: {
      model: "مدل",
      tag: "تگ",
    ...
    actions: {
      telegram: "نمایش در تلگرام",
      view: "نمایش پرامپت",
    },
    empty: {
      title: "پرامپتی پیدا نشد",
      description: "عبارت دیگری جستجو کنید یا فیلترهای فعال را پاک کنید.",
    },
    error: {
      title: "بارگذاری آرشیو پرامپت‌ها انجام نشد",
      retry: "تلاش دوباره",
    },
    loadMore: "نمایش بیشتر ({count} مورد باقی‌مانده)",
    view: {
      grid: "نمایش گرید",
      list: "نمایش لیست",
    },
    items: {
      "6": {
        title: "پرتره اکسپرسیونیستی مالیخولیایی",
      },
      "14": {
        title: "میم ترول کودکانه دست‌کشیده",
      },
      "20": {
        title: "پرتره مجسمه‌ای پاپ‌سورئال",
      },
      "26": {
        title: "کاراکتر گوتیک سه‌بعدی",
      },
      "31": {
        title: "مجسمه رزینی رتروفیوچریستی",
      },
      "39": {
        title: "مجسمه مسی گرافیتی",
      },
      "51": {
        title: "عروسک فشن سورئال",
      },
      "60": {
        title: "انیمیشن دوبعدی گوتیک",
      },
      "66": {
        title: "نیم‌تنه گچی فشن",
      },
      "70": {
        title: "کاراکتر سه‌بعدی نقاشی‌شده سینمایی",
      },
      "83": {
        title: "استاپ‌موشن کورالاین",
      },
      "90": {
        title: "مجسمه رزینی رنگارنگ",
      },
      "96": {
        title: "پرتره کلاغ گوتیک",
      },
      "104": {
        title: "کاراکتر ماینکرفت سه‌بعدی",
      },
      "115": {
        title: "پوستر تبلیغاتی دهه ۱۹۵۰",
      },
      "120": {
        title: "پرتره مجله‌ای دهه ۱۹۵۰",
      },
      "130": {
        title: "پرتره انیمه دیستوپیایی",
      },
      "137": {
        title: "مرد سایبرپانک نئونی",
      },
      "143": {
        title: "زن سایبرپانک نئونی",
      },
      "149": {
        title: "دنیای لگویی سه‌بعدی",
      },
      "156": {
        title: "کاراکتر شاخ‌دار مرموز",
      },
      "165": {
        title: "پوستر The Rings of Power",
      },
      "172": {
        title: "پرتره گوتیک ویکتوریایی",
      },
      "177": {
        title: "پرتره گوتیک ویکتوریایی مردانه",
      },
      "182": {
        title: "پرتره Family Guy",
      },
      "189": {
        title: "کاراکتر کاغذی South Park",
      },
      "197": {
        title: "کاراکتر Rick and Morty",
      },
      "203": {
        title: "آرچر کوئین Clash Royale",
      },
      "208": {
        title: "آرچر کوئین رئالیستیک",
      },
      "217": {
        title: "کاراکتر گوتیک سه‌بعدی سینمایی",
      },
      "224": {
        title: "کاراکتر هندسی GeoToon",
      },
      "230": {
        title: "کاراکتر سه‌بعدی فانتزی پاستلی",
      },
      "238": {
        title: "کاراکتر سه‌بعدی مدوسا",
      },
      "244": {
        title: "انیمه شهر اشباح",
      },
      "249": {
        title: "پوستر GTA San Andreas",
      },
      "254": {
        title: "عکس بازاری حرم امام رضا",
      },
      "260": {
        title: "پوستر GTA VI",
      },
      "265": {
        title: "کاراکتر تمام‌قد Wolfwalkers",
      },
      "271": {
        title: "پرتره Wolfwalkers",
      },
      "277": {
        title: "پوستر Red Dead Redemption",
      },
      "284": {
        title: "کاراکتر Red Dead Redemption II",
      },
      "291": {
        title: "پرتره استودیویی حیوان خانگی",
      },
      "299": {
        title: "مجسمه رزینی کارتونی",
      },
      "307": {
        title: "آواتار گرافیتی نئونی",
      },
      "313": {
        title: "عکس پرسنلی ایرانی ۳×۴",
      },
      "321": {
        title: "آواتار پیکسلی 64-bit",
      },
      "328": {
        title: "کاراکتر پیکسلی 32-bit تمام‌قد",
      },
      "333": {
        title: "عکس پاسپورت استودیویی",
      },
      "341": {
        title: "آواتار فلت پاستلی",
      },
      "351": {
        title: "فیگور سفالی کشیده",
      },
      "357": {
        title: "کلوزآپ مجسمه رزینی",
      },
      "371": {
        title: "کلاه سانتا هماهنگ با تصویر",
      },
      "378": {
        title: "گریم کامل بابانوئل",
      },
      "386": {
        title: "سفال واقعی از نقاشی کودکانه",
      },
      "387": {
        title: "افزودن پارتنر به عکس",
      },
      "401": {
        title: "صحنه واقعی سفارشی",
      },
      "409": {
        title: "کاراکتر کارتونی وینتیج واقعی",
      },
      "413": {
        title: "تام و جری با اجرای واقعی",
      },
      "416": {
        title: "هدشات حرفه‌ای LinkedIn",
      },
      "419": {
        title: "تامبنیل حرفه‌ای YouTube",
      },
      "426": {
        title: "کاراکتر پانک سه‌بعدی",
      },
      "429": {
        title: "کاراکتر دوبعدی هندسی دفرمه",
      },
      "430": {
        title: "مجسمه کاریکاتوری گروتسک",
      },
      "434": {
        title: "تصویرسازی هندسی قلم‌ومرکب",
      },
      "435": {
        title: "نقاشی کودکانه سورئال",
      },
      "439": {
        title: "پرتره سورئال ارگانیک رئالیستیک",
      },
      "441": {
        title: "جلد مجله Vogue",
      },
      "443": {
        title: "بدنساز فوق‌عضلانی",
      },
      "445": {
        title: "عکس محصول فروشگاهی",
      },
      "449": {
        title: "پوستر تبلیغاتی محصول",
      },
      "451": {
        title: "عروسک نمدی خیمه‌شب‌بازی",
      },
      "452": {
        title: "پیش‌نمایش پرو لباس",
      },
      "457": {
        title: "پوستر سینمایی شخصی",
      },
      "461": {
        title: "کاریکاتور فشن سه‌بعدی",
      },
      "465": {
        title: "کاراکتر پیکسلی چمباتمه‌زده",
      },
      "466": {
        title: "پرتره سینمایی CGI",
      },
      "467": {
        title: "جلد کتاب از اطلاعات متنی",
      },
      "468": {
        title: "پوستر استریت‌آرت ژاپنی",
      },
      "473": {
        title: "مجسمه بامبویی دست‌ساز",
      },
      "474": {
        title: "کاراکتر کارتونی آبرنگی",
      },
      "475": {
        title: "کاراکتر کارتونی سه‌بعدی استودیویی",
      },
      "476": {
        title: "کاراکتر Claymation والاس و گرومیت",
      },
      "477": {
        title: "سلفی آینه‌ای Claymation",
      },
      "478": {
        title: "پرتره ناگهانی از بالا",
      },
      "479": {
        title: "کاراکتر آلومینیومی وان پیس",
      },
      "481": {
        title: "پوستر میوه جادویی وان پیس",
      },
      "482": {
        title: "کاراکتر پاپ‌آرت کشیده",
      },
      "485": {
        title: "سلفی در لوکیشن مرجع",
      },
      "486": {
        title: "ادیتوریال فشن در استخر اشیا",
      },
      "487": {
        title: "پرتره پاپاراتزی پشت پنجره",
      },
      "490": {
        title: "گرید تست اکسپرشن ۳×۳",
      },
      "492": {
        title: "گرید اکسپرشن و مدل مو ۳×۳",
      },
      "497": {
        title: "زندگی روزمره در دوران تاریخی",
      },
      "501": {
        title: "زوج در دشت گل",
      },
      "502": {
        title: "انیمه کلاسیک دهه ۸۰ و ۹۰",
      },
      "503": {
        title: "پوستر مینیاتور ایرانی",
      },
      "506": {
        title: "پرتره پروانه‌ای فاین‌آرت",
      },
      "507": {
        title: "کارت تاروت شخصی",
      },
      "510": {
        title: "پرتره دونفره کژوال",
      },
      "511": {
        title: "پرتره طبیعی LinkedIn",
      },
    },
  },
}
