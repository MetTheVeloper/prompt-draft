export default {
  ...
  tools: {
    imageVectorizer: {
      ...
      subtitle: "Convert simple flat logos and low-color images into editable SVG paths directly in your browser.",
      empty: {
        title: "Drop a simple image here",
        description: "Choose a flat PNG, JPG, or WebP logo with a simple background and a limited number of colors.",
        action: "Choose image",
      },
      selected: {
      ...
      controls: {
        ...
        maxColorsHint: "The output palette is reduced to this number unless strict mode is enabled.",
        colorTolerance: "Color tolerance",
        colorToleranceHint: "Higher values merge nearby JPEG and anti-aliasing colors more aggressively.",
        strictColorLimit: "Reject images above the color limit",
        strictColorLimitHint: "When enabled, processing stops instead of reducing an image with too many detected colors.",
        ...
        minRegionSizeHint: "Small isolated regions below this scale are treated as compression noise.",
        smooth: "Path smoothness",
        smoothHint: "Analyzes straight lines, curves, and protected corners separately. Higher values clean curves and stair-step edges without rounding intentional breaks.",
      },
      values: {
        colors: "{count} colors",
      },
      ...
      messages: {
        ...
        colorLimitExceeded: "This image contains about {detected} color groups, above the selected limit of {max}. Increase color tolerance or the maximum color count, disable strict mode, or choose a simpler image.",
        processingFailed: "The image could not be vectorized. Try a simpler image, increase color tolerance, or reduce the input dimensions.",
        clipboardUnavailable: "Clipboard access for this action is not supported by this browser.",
        clipboardPermissionDenied: "Clipboard permission was denied. Allow clipboard access and try again.",
