  ...
  growth: {
    ...
    discovery: {
      ...
      personalized: {
        ...
        description: 'Jump into the Prompt Archive through the visual directions you selected.',
        edit: 'Edit interests',
        open: 'Explore',
      },
      anonymous: {
        title: 'Make discovery yours',
        description: 'Sign in to save your interests and personalize the homepage.',
        action: 'Sign in to personalize',
      },
      common: {
        cancel: 'Cancel',
