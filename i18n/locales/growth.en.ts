export default {
  ...
  campaign: {
    eyebrow: 'CAMPAIGN',
    endsAt: 'Ends {date}',
    rendererUnavailable: 'This campaign experience is not available yet.',
    status: {
      draft: 'Draft',
      scheduled: 'Scheduled',
      active: 'Active',
    ...
    participation: {
      title: 'Participation',
      loading: 'Checking your campaign state...',
      signIn: 'Sign in to join',
      signInHelper: 'Sign in to participate. Campaign eligibility and rewards are always decided by Prompt Draft.',
      start: 'Start campaign',
      starting: 'Starting...',
      startHelper: 'You are eligible to join this campaign.',
      joined: 'You joined this campaign.',
      currentStatus: 'Current status: {status}',
      notEligible: 'This campaign is not currently available for your account.',
      closed: 'Participation is not open right now.',
      error: 'Campaign participation could not be started. Please try again.',
      status: {
        started: 'Started',
        ...
        expired: 'Expired',
        reward_failed: 'Reward pending review',
      },
    },
    rewards: {
