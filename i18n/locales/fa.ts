export default {
  ...
  tools: {
    imageVectorizer: {
      ...
      subtitle: "لوگوها و تصاویر فلت کم‌رنگ را مستقیماً در مرورگر به مسیرهای SVG قابل ویرایش تبدیل کنید.",
      empty: {
        title: "تصویر ساده را اینجا رها کنید",
        description: "یک لوگوی فلت PNG، JPG یا WebP با پس‌زمینه ساده و تعداد رنگ محدود انتخاب کنید.",
        action: "انتخاب تصویر",
      },
      selected: {
      ...
      controls: {
        ...
        colorToleranceHint: "مقادیر بیشتر، رنگ‌های نزدیک حاصل از فشرده‌سازی JPG و لبه‌های Anti-alias را بیشتر با هم ادغام می‌کنند.",
        strictColorLimit: "رد کردن تصاویر بیشتر از محدودیت رنگ",
        strictColorLimitHint: "با فعال بودن این گزینه، تصویر پررنگ به‌جای کاهش پالت پردازش نمی‌شود.",
        ...
        minRegionSizeHint: "ناحیه‌های جداافتاده کوچک‌تر از این مقیاس به‌عنوان نویز فشرده‌سازی حذف می‌شوند.",
        smooth: "نرمی مسیر",
        smoothHint: "خطوط مستقیم، منحنی‌ها و شکست‌های محافظت‌شده جداگانه تحلیل می‌شوند؛ مقدار بیشتر منحنی‌ها و لبه‌های پله‌ای را تمیز می‌کند، بدون اینکه گوشه‌های عمدی گرد شوند.",
      },
      values: {
        colors: "{count} رنگ",
      },
      ...
      messages: {
        ...
        colorLimitExceeded: "در این تصویر حدود {detected} گروه رنگ تشخیص داده شد که از محدودیت {max} بیشتر است. تلورانس یا حداکثر تعداد رنگ را افزایش دهید، حالت سخت‌گیرانه را خاموش کنید یا تصویر ساده‌تری انتخاب کنید.",
        processingFailed: "تبدیل تصویر به وکتور انجام نشد. یک تصویر ساده‌تر امتحان کنید، تلورانس رنگ را افزایش دهید یا ابعاد تصویر ورودی را کاهش دهید.",
        clipboardUnavailable: "دسترسی لازم به کلیپ‌بورد برای این عملیات در مرورگر پشتیبانی نمی‌شود.",
        clipboardPermissionDenied: "مجوز دسترسی به کلیپ‌بورد رد شد. دسترسی را فعال و دوباره تلاش کنید.",
