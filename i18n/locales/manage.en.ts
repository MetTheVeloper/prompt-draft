  ...
  manage: {
    ...
    sections: {
      ...
      archive: {
        ...
        description: "Manage Prompt Archive metadata, publication state, tags, and prepared media.",
      },
    },
    common: {
      actions: {
    ...
    archive: {
      ...
      editor: {
        ...
        saveDraftHint: "Metadata saves are draft-first. Publishing is always a separate explicit action.",
        ...
        savedWithLocalImages: "Metadata was saved as a managed draft. Prepared images are still local-only until Object Storage is connected.",
        saveFailedTitle: "Archive save failed",
        saveFailed: "Archive metadata could not be saved.",
        publishBlockedTitle: "Images are not uploaded yet",
        publishBlockedLocalImages: "This draft contains locally prepared images. Object Storage is not connected in this phase, so publishing is blocked until those images can be uploaded and persisted.",
      ...
      images: {
        ...
        localOnlyNotice: "Prepared images are held in browser memory only in Phase 17C. Nothing is uploaded to ArvanCloud yet.",
      },
    },
    errors: {
